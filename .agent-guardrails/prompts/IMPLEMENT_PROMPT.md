...
1. Read ONLY the exact target module file(s) given in the task instruction. Do NOT read AGENTS.md, docs/PROJECT_STATE.md, or README.md unless one of them is explicitly named as a file to read for this specific task — reading unrelated docs unprompted has previously caused a subagent to hit its context-compaction threshold before finishing its actual work (real incident, 2026-07-17).
