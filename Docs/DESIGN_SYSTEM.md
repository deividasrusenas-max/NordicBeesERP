# NordicBeesERP — Design System

> Applies to general forms/dialogs/view pages. For list-page FILTER bars
> specifically, see `Docs/UI_STANDARD.md` (which uses `Variant.Text` for
> filter fields — a different, narrower context from the general form
> fields below).
...
## Formos (bendri dialogų/create/edit laukai — NE filtrų juosta)
