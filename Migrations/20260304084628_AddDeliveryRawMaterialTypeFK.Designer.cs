...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260304084628_AddDeliveryRawMaterialTypeFK")]
    partial class AddDeliveryRawMaterialTypeFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 3, 4, 10, 46, 27, 802, DateTimeKind.Local).AddTicks(1390),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 3, 4, 10, 46, 27, 802, DateTimeKind.Local).AddTicks(1420)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 3, 4, 10, 46, 27, 802, DateTimeKind.Local).AddTicks(1420),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2026, 3, 4, 10, 46, 27, 802, DateTimeKind.Local).AddTicks(1430)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 3, 4, 10, 46, 27, 802, DateTimeKind.Local).AddTicks(1430),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Pikis",
                            SortOrder = 3,
