...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260527212708_AddDefaultExpenseCategoryToSupplier")]
    partial class AddDefaultExpenseCategoryToSupplier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5000),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5070)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5080),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5080)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5100),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Pikis",
                            SortOrder = 3,
                            UpdatedAt = new DateTime(2026, 5, 28, 0, 27, 7, 597, DateTimeKind.Local).AddTicks(5100)
                        },
                        new
                        {
                            Id = 4,
            ...
            modelBuilder.Entity("NordicBeesERP.Models.BankImport", b =>
                {
                    b.HasOne("NordicBeesERP.Models.User", "CreatedByUser")
                        .WithMany()
