...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260528122719_AddManagerWarehouseRoles")]
    partial class AddManagerWarehouseRoles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 5, 28, 15, 27, 18, 780, DateTimeKind.Local).AddTicks(1540),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 5, 28, 15, 27, 18, 780, DateTimeKind.Local).AddTicks(1590)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 5, 28, 15, 27, 18, 780, DateTimeKind.Local).AddTicks(1600),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2026, 5, 28, 15, 27, 18, 780, DateTimeKind.Local).AddTicks(1600)
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            Name = "Vaškas",
                            SortOrder = 5,
                            UpdatedAt = new DateTime(2026, 5, 28, 15, 27, 18, 780, DateTimeKind.Local).AddTicks(1610)
                        });
                });
