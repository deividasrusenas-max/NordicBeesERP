...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260601152818_AddMissingProdColumns")]
    partial class AddMissingProdColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 1, 18, 28, 18, 474, DateTimeKind.Local).AddTicks(2840),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 6, 1, 18, 28, 18, 474, DateTimeKind.Local).AddTicks(2870)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 6, 1, 18, 28, 18, 474, DateTimeKind.Local).AddTicks(2870),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
