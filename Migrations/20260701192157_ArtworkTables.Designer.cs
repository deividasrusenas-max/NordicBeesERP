...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260701192157_ArtworkTables")]
    partial class ArtworkTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 1, 19, 21, 57, 375, DateTimeKind.Utc).AddTicks(5780),
                            IsActive = true,
                            Name = "Nordic Bees",
                            Slug = "nordic-bees"
                        },
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 7, 1, 22, 21, 57, 371, DateTimeKind.Local).AddTicks(1770),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 7, 1, 22, 21, 57, 371, DateTimeKind.Local).AddTicks(1830)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 7, 1, 22, 21, 57, 371, DateTimeKind.Local).AddTicks(1830),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 7, 1, 22, 21, 57, 371, DateTimeKind.Local).AddTicks(1840),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Propolis",
                            SortOrder = 4,
                            UpdatedAt = new DateTime(2026, 7, 1, 22, 21, 57, 371, DateTimeKind.Local).AddTicks(1840)
                        },
                        new
                        {
                            Id = 5,
