...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260828070929_AddDashboardDailySnapshots")]
    partial class AddDashboardDailySnapshots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 8, 28, 7, 9, 29, 500, DateTimeKind.Utc).AddTicks(7140),
                            IsActive = true,
                            Name = "Nordic Bees",
                            Slug = "nordic-bees"
                        },
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 8, 28, 10, 9, 29, 500, DateTimeKind.Local).AddTicks(3580),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 8, 28, 10, 9, 29, 500, DateTimeKind.Local).AddTicks(3650)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 8, 28, 10, 9, 29, 500, DateTimeKind.Local).AddTicks(3650),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 8, 28, 10, 9, 29, 500, DateTimeKind.Local).AddTicks(3660),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Propolis",
                            SortOrder = 4,
                            UpdatedAt = new DateTime(2026, 8, 28, 10, 9, 29, 500, DateTimeKind.Local).AddTicks(3660)
                        },
                        new
                        {
                            Id = 5,
