...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260903115521_AddDeliveryCostDeductions")]
    partial class AddDeliveryCostDeductions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 3, 11, 55, 21, 3, DateTimeKind.Utc).AddTicks(2520),
                            IsActive = true,
                            Name = "Nordic Bees",
                            Slug = "nordic-bees"
                        },
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 3, 14, 55, 21, 2, DateTimeKind.Local).AddTicks(8740),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 9, 3, 14, 55, 21, 2, DateTimeKind.Local).AddTicks(8830)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 9, 3, 14, 55, 21, 2, DateTimeKind.Local).AddTicks(8840),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                            UpdatedAt = new DateTime(2026, 9, 3, 14, 55, 21, 2, DateTimeKind.Local).AddTicks(8840)
                        },
                        new
                        {
                            Id = 3,
