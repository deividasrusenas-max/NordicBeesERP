...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260907083424_AddCompensationVatCode")]
    partial class AddCompensationVatCode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 7, 8, 34, 23, 838, DateTimeKind.Utc).AddTicks(4910),
                            IsActive = true,
                            Name = "Nordic Bees",
                            Slug = "nordic-bees"
                        },
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 7, 11, 34, 23, 838, DateTimeKind.Local).AddTicks(1400),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 9, 7, 11, 34, 23, 838, DateTimeKind.Local).AddTicks(1430)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 9, 7, 11, 34, 23, 838, DateTimeKind.Local).AddTicks(1430),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 9, 7, 11, 34, 23, 838, DateTimeKind.Local).AddTicks(1440),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Propolis",
                            SortOrder = 4,
                            UpdatedAt = new DateTime(2026, 9, 7, 11, 34, 23, 838, DateTimeKind.Local).AddTicks(1440)
                        },
                        new
                        {
                            Id = 5,
