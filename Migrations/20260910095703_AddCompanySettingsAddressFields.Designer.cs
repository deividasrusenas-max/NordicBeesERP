...
namespace NordicBeesERP.Migrations
{
    ...
    [Migration("20260910095703_AddCompanySettingsAddressFields")]
    partial class AddCompanySettingsAddressFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 10, 9, 57, 2, 990, DateTimeKind.Utc).AddTicks(9380),
                            IsActive = true,
                            Name = "Nordic Bees",
                            Slug = "nordic-bees"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 9, 10, 9, 57, 2, 990, DateTimeKind.Utc).AddTicks(9390),
                            IsActive = true,
                            Name = "Honeymark",
                            Slug = "honeymark"
                        },
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AssetId", "LabelType")
                        .IsUnique()
                        .HasDatabaseName("uq_asset_label_type");

                    b.ToTable("artwork_files");
                });

            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkLabelType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Artwork.ArtworkVersion", b =>
                {
                    ...
                    b.Property<int?>("ArtworkFileId")
                        .HasColumnType("int")
                        .HasColumnName("artwork_file_id");
            ...
            modelBuilder.Entity("NordicBeesERP.Models.BusinessPartner", b =>
                {
                    ...
                    b.Property<string>("CompensationVatCode")
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)")
                        .HasColumnName("compensation_vat_code");
                    ...
                    b.Property<bool>("IsExpenseSupplier")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_expense_supplier");
                    ...
                    b.Property<bool?>("VatVerified")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("vat_verified");

                    b.Property<DateTime?>("VatVerifiedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("vat_verified_at");

                    b.Property<string>("VatVerifiedName")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)")
                        .HasColumnName("vat_verified_name");
            ...
            modelBuilder.Entity("NordicBeesERP.Models.DashboardDailySnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BarrelsCount")
                        .HasColumnType("int")
                        .HasColumnName("barrels_count");

                    b.Property<decimal>("BarrelsKg")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasColumnName("barrels_kg");

                    b.Property<int>("BucketsCount")
                        .HasColumnType("int")
                        .HasColumnName("buckets_count");

                    b.Property<decimal>("BucketsKg")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasColumnName("buckets_kg");
                    ...
                    b.Property<int>("SupplierDebtCount")
                        .HasColumnType("int")
                        .HasColumnName("supplier_debt_count");

                    b.Property<decimal>("SupplierDebtTotal")
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasColumnName("supplier_debt_total");

                    b.Property<int>("UnpricedDeliveriesCount")
                        .HasColumnType("int")
                        .HasColumnName("unpriced_deliveries_count");
                    ...
                    b.ToTable("dashboard_daily_snapshots");
                });
            ...
            modelBuilder.Entity("NordicBeesERP.Models.Invoice", b =>
                {
                    ...
                    b.Property<string>("CustomerVatCode")
                        .HasColumnType("longtext")
                        .HasColumnName("customer_vat_code");
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.Delivery", b =>
                {
                    ...
                    b.Property<decimal?>("BarrelCostDeduction")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("barrel_cost_deduction");
                    ...
                    b.Property<decimal?>("OtherCostDeduction")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("other_cost_deduction");
                    ...
                    b.Property<string>("SupplierSignatureSvg")
                        .HasColumnType("longtext")
                        .HasColumnName("supplier_signature_svg");

                    b.Property<DateTime?>("SupplierSignedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("supplier_signed_at");

                    b.Property<string>("SupplierSignerName")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("supplier_signer_name");
                    ...
                    b.Property<decimal?>("TransportCostDeduction")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("transport_cost_deduction");
            ...
            modelBuilder.Entity("NordicBeesERP.Models.WarehouseModule.RawMaterialType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 10, 12, 57, 2, 990, DateTimeKind.Local).AddTicks(5560),
                            IsActive = true,
                            IsHoney = true,
                            Name = "Medus",
                            SortOrder = 1,
                            UpdatedAt = new DateTime(2026, 9, 10, 12, 57, 2, 990, DateTimeKind.Local).AddTicks(5610)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 9, 10, 12, 57, 2, 990, DateTimeKind.Local).AddTicks(5610),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Bičių duona",
                            SortOrder = 2,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 9, 10, 12, 57, 2, 990, DateTimeKind.Local).AddTicks(5620),
                            IsActive = true,
                            IsHoney = false,
                            Name = "Propolis",
                            SortOrder = 4,
                            UpdatedAt = new DateTime(2026, 9, 10, 12, 57, 2, 990, DateTimeKind.Local).AddTicks(5620)
                        },
                        new
                        {
                            Id = 5,
